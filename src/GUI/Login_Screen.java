...
//            
//          
//             project = new Project("Holikasd", Priorities.NORMAL, "hehe", "11", "Vyuplnovi dilino jako.");
//             team = new Team(Loader.getUsers(), "Tim cislo jednicak");
//            project.add(team);
//             user = Loader.getUsers().get(0);
